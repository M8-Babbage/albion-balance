...
function loadCommands(client) {
  ...
  console.log(
    "📂 Carpetas de comandos detectadas:",
    commandFolders.length > 0 ? commandFolders : "Ninguna"
  );
  console.log(
    "📂 Archivos Raiz de comandos detectados:",
    commandFilesRoot.length > 0 ? commandFilesRoot : "Ninguno",
    "\n"
  );
